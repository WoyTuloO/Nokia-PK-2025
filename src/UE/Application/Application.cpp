...
Application::Application(
    common::PhoneNumber phoneNumber, common::ILogger &iLogger, IBtsPort &bts, IUserPort &user, ITimerPort &timer)
...
void Application::handleCallTalk(common::PhoneNumber to, const std::string &text)
{
    context.state->handleCallTalk(to, text);
}
